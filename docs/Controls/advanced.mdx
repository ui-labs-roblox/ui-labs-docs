...
Advanced controls are controls that allow you to add complex values to your stories, These controls are not available in Flipbook.
...
import { Choose, EnumList, Slider, RGBA } from "@rbxts/ui-labs"; //import the constructor functions
